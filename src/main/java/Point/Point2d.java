...
public class Point2d extends AbstractPoint {
    ...
    public Point2d rotate(Double angle) {
        Double[][] rotatedPoint = new Double[2][2];
        rotatedPoint[0][0] = Math.cos(angle);
        rotatedPoint[0][1] = -Math.sin(angle);
        rotatedPoint[1][0] = Math.sin(angle);
        rotatedPoint[1][1] = Math.cos(angle);
        return rotate(rotatedPoint);
    }
